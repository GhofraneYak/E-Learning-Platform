...
<!-- END SIGN IN -->
    ...
    <main>
      <section class="home-intro">
        <img src="<?php echo base_url('assets/images/g&f/img1.jpg') ?>" style="width: 100%" >
      </section>
    </main>
...
<br><br><br><br>
            ...
            <div class="container">
                ...
                <div class="myForm">
                <form action='<?php echo base_url("index.php/Contact/add");?>' method='post'>
                    <table class="table table-borderless">
                        <tr>
                            <th>First Name <span class="nb">*</span></th>
                            <th>Last Name <span class="nb">*</span></th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th>University / Work place</th>
                            <th>Email <span class="nb">*</span></th>
                        </tr>
                        <tr>
                            <td><input type="text" class="form-control" id="university" ></td>
                            <td><input type="text" class="form-control" id="email" ></td>
                        </tr>
                    </table>
                        
                    <label for="name" style="margin-left:10px ;"class="fr"> Telephone Number</label><br>
                    <input type="text" style="margin-left:10px ;"class="form-control" id="tel" ><br>
                        <label for="name"style="margin-left:10px ;" class="fr"> Message / comments</label><br>
                        <textarea style="margin-left:10px ;" class="form-control" style="width: 1000px;height: 200px;" id="comment" ></textarea><br>
                        
                    
                  
                    <a class="nav__link nav__link--btn nav__link--btn--highlight">Submit</a>
                </form>
                </div>
              </div>
...
<footer style="background-color: #f4f4f4; width: 100%;">
